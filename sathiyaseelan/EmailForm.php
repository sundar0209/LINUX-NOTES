<?php
			...
			$to = "sathiya.jayaraman@zhagaramss.com";

			$fromemail = $email;	 
			$subject = 'REACHMEOUT | Enquiry Form';
			$curdate = date('d-m-Y');
		...
		<div style="float:left;margin:20px 0px 10px 20px;" class=""></div>
		...
		REACHMEOUT</div>
		<div style="font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#3d3d3d;font-weight:normal;clear:both;margin:0px 0px 48px 0px;text-align:center;" class="emailtemp_respect_copyright">&copy; 2020 Zhagaram Team All rights reserved </div>
		</div>
		</div>';
